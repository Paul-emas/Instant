    ...
    <div className="terms mx-auto px-4 xl:container xl:px-14">
      <div className="py-36">
        <div className="mx-auto max-w-3xl">
          <h1 className="text-4.5xl font-bold">Privacy and Policy</h1>
          ...
          <div className="mt-14">
            ...
            <div className="text-lg font-semibold">Usage Data</div>
            <div className="my-5 text-justify leading-loose">
            ...
            <div className="text-2xl font-semibold">Tracking & Cookies Data</div>
            <div className="my-5 text-justify leading-loose">
            ...
            <div className="text-2xl font-semibold">Use of Data</div>
            <div className="my-5 text-justify leading-loose">
              Instant Energy Technologies and Renewables LTD uses the collected data for various purposes:
              <ul className="list-disc pl-8 text-sm leading-loose">
            ...
            <div className="text-2xl font-semibold">Transfer of Data</div>
            <div className="my-5 text-justify leading-loose">
            ...
            <div className="text-2xl font-semibold">Disclosure of Data</div>
            ...
            <div className="text-2xl font-semibold">Security of Data</div>
            <div className="my-5 text-justify leading-loose">
              The security of your data is important to us, but remember that no method of transmission over the
              Internet, or method of electronic storage is 100% secure. While we strive to use commercially acceptable
              means to protect your Personal Data, we cannot guarantee its absolute security.
            </div>
            <div className="text-2xl font-semibold">Service Providers</div>
            <div className="my-5 text-justify leading-loose">
              The security of your data is important to us, but remember that no method of transmission over the
              Internet, or method of electronic storage is 100% secure. While we strive to use commercially acceptable
              means to protect your Personal Data, we cannot guarantee its absolute security.
            ...
            <div className="text-2xl font-semibold">Links to Other Sites</div>
            <div className="my-5 text-justify leading-loose">
            ...
            <div className="text-2xl font-semibold">Children’s Privacy</div>
            <div className="my-5 text-justify leading-loose">
